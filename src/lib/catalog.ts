...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    subcategories: [
      { slug: "football-kits", name: "Football Kits", sku: "PB-TM-FK", description: "Jersey, shorts and socks. Cut-and-sew or full sublimation." },
      { slug: "cricket-uniforms", name: "Cricket Uniforms", sku: "PB-TM-CR", description: "T20, ODI and Test whites with custom branding." },
      { slug: "basketball-jerseys", name: "Basketball Jerseys", sku: "PB-TM-BB", description: "Reversible mesh and tackle-twill jerseys." },
      { slug: "volleyball-hockey", name: "Volleyball & Hockey Kits", sku: "PB-TM-VH", description: "Indoor and field kits for clubs and leagues." },
      { slug: "sublimation", name: "Custom Sublimation Uniforms", sku: "PB-TM-SB", description: "Edge-to-edge dye sublimation, unlimited colors." },
    ],
  },
  {
    ...
    subcategories: [
      { slug: "moisture-wicking", name: "Moisture-Wicking Tees", sku: "PB-PF-MW", description: "Open-knit poly tees that move sweat to the surface." },
      { slug: "quick-dry", name: "Quick-Dry Apparel", sku: "PB-PF-QD", description: "Fast-drying woven and knit pieces for hot climates." },
      { slug: "running", name: "Lightweight Running Wear", sku: "PB-PF-RN", description: "Sub-150gsm running tops, shorts and singlets." },
      { slug: "thermal", name: "Thermal Wear", sku: "PB-PF-TH", description: "Brushed-back baselayers for cold-weather training." },
    ],
  },
  {
    slug: "outerwear",
  ...
  },
  {
    ...
    subcategories: [
      { slug: "yoga-sets", name: "Yoga Sets", sku: "PB-YL-YS", description: "Matching bra and legging sets in buttery nylon-spandex." },
      { slug: "stretch-leggings", name: "Stretch Leggings", sku: "PB-YL-SL", description: "Four-way stretch leggings with sculpting seams." },
      { slug: "lifestyle", name: "Lifestyle Sportswear", sku: "PB-YL-LS", description: "Crewnecks, joggers and tees for everyday wear." },
      { slug: "casual", name: "Casual Sporty Clothing", sku: "PB-YL-CS", description: "Easy fits in heavy cotton and modal blends." },
    ],
  },
  {
    slug: "sport-specific",
    ...
    subcategories: [
      { slug: "cycling", name: "Cycling Wear", sku: "PB-SS-CY", description: "Jerseys, bib shorts and gilets with race-cut construction." },
      { slug: "swimwear", name: "Swimwear", sku: "PB-SS-SW", description: "Chlorine-resistant racing and training swimwear." },
      { slug: "tennis", name: "Tennis Wear", sku: "PB-SS-TN", description: "Polos, skirts and shorts in performance pique." },
      { slug: "golf", name: "Golf Wear", sku: "PB-SS-GF", description: "Premium polos, quarter-zips and trousers." },
      { slug: "winter", name: "Winter Sportswear", sku: "PB-SS-WT", description: "Insulated layers for ski, snowboard and alpine training." },
    ],
  },
  {
    slug: "accessories",
    ...
    subcategories: [
      { slug: "caps", name: "Caps", sku: "PB-AC-CP", description: "5- and 6-panel caps with structured and unstructured crowns." },
      { slug: "socks", name: "Socks", sku: "PB-AC-SK", description: "Crew, ankle and compression socks in technical blends." },
      { slug: "gym-bags", name: "Gym Bags", sku: "PB-AC-GB", description: "Duffles and backpacks in ballistic nylon and cordura." },
      { slug: "gloves", name: "Gloves", sku: "PB-AC-GL", description: "Training, lifting and cycling gloves with padded palms." },
    ],
  },
];
